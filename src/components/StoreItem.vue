...
export default {
  props: {
    item: {
      type: Object,
      required: true // Ensures that an item object is always passed
    }
  },
  methods: {
    addToCart() {
      // Emits an event with the current item to the parent component
...
<style scoped>
/* Scoped styles for the StoreItem component */
.store-item {
